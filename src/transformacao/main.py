...
# Adicionar a coluna _spurce com um valor
...
# Remover as antigas colunas de preço
df.drop(
    columns=[
        "old_price_reais",
        "old_price_centavos",
...
df.to_sql("mercadolivre_item", conn, if_exists="replace", index=False)
